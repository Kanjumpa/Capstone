...
class GuiSkeleton(QtGui.QWidget):
    ...
    def create_coincidence_photon_box(self):
        ...
        self.raw_label1 = QtGui.QLabel('Raw Coincidence')
        self.stat_label1 = QtGui.QLabel('Statistical Correction')
        self.corrected_label1 = QtGui.QLabel('Corrected Coincidence')
        
        self.raw_label2 = QtGui.QLabel('Raw Coincidence')
        self.stat_label2 = QtGui.QLabel('Statistical Correction')
        self.corrected_label2 = QtGui.QLabel('Corrected Coincidence')
        ...
        self.coincidence_photon_grid.addWidget(self.corrected_label1, 1,0)        
        ...
        self.coincidence_photon_grid.addWidget(self.stat_label1, 2,0)
        ...
        self.coincidence_photon_grid.addWidget(self.raw_label1, 3,0)
        ...
        self.coincidence_photon_grid.addWidget(self.corrected_label2, 5,0)
        ...
        self.coincidence_photon_grid.addWidget(self.stat_label2, 6,0)
        ...
        self.coincidence_photon_grid.addWidget(self.raw_label2, 7,0)
